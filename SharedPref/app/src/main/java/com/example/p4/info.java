...
import com.example.p4.fragments.DetailFragment;
import com.example.p4.fragments.MenuFragment;

public class info extends AppCompatActivity  implements MenuFragment.OnItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragactivity2);
