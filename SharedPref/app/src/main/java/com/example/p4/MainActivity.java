...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView offerRecyclerView , bestSellerRecyclerView , clothingRecyclerView , bestSellerRecyclerView2, clothingRecyclerView1, offerRecyclerView1 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /// offer RecyclerView
        offerRecyclerView1 = findViewById(R.id.offer1RecyclerView);
        offerRecyclerView1.setHasFixedSize(true);
        offerRecyclerView1.setLayoutManager(new LinearLayoutManager(this , LinearLayoutManager.HORIZONTAL , false));
//
//        List<Integer> image1List = new ArrayList<>();
//
//        imageList.add(R.drawable.offer_shoping);
//        imageList.add(R.drawable.nikon_canon_offer);
//        imageList.add(R.drawable.tv_offer);
//
//        OfferAdapter offer1Adapter = new OfferAdapter(image1List);

        offerRecyclerView1.setAdapter(offerAdapter);

        // clothing RecyclerView

        clothingRecyclerView1 = findViewById(R.id.clothing1Recyclerview);
        clothingRecyclerView1.setHasFixedSize(true);
        clothingRecyclerView1.setLayoutManager(new LinearLayoutManager(this , LinearLayoutManager.HORIZONTAL , false));

//        List<Clothing> clothing1List = new ArrayList<>();
//
//        clothing1List.add(new Clothing(R.drawable.levis_clothing , "Up to 30% off"));
//        clothing1List.add(new Clothing(R.drawable.women_clothing , "Up to 30% off"));
//        clothing1List.add(new Clothing(R.drawable.nikeshoes , "Up to 30% off"));
//
//        ClothingAdapter clothing1Adapter = new ClothingAdapter(clothing1List);
        clothingRecyclerView1.setAdapter(clothingAdapter);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            notification = new Notification.Builder(this)
                    ...
                    .setContentText("50% Off on all Electronics,\nits Shopping time.")
                    .setSubText(" Check this out ")
